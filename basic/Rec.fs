...
module RecursiveModule =
    ...
    type Banana(orientation : Orientation) =
        ...
        member val Sides : PeelState list = [ Unpeeled; Unpeeled; Unpeeled; 
                                              Unpeeled ] with get, set
    ...
    module private BananaHelpers =
        let peel (b : Banana) =
            ...
            let peelSides (banana : Banana) =
                banana.Sides <- List.map (fun side -> 
                                    if side = Unpeeled then Peeled
                                    else side) banana.Sides
                banana
